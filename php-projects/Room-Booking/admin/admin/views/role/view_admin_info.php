                           ...
                           <?php if(validation_errors() != ""){ ?>
							...
							<legend>Personal Information</legend>
                              ...
                              <div class="control-group">
								...
								<div class="controls">
								  <input class="input-xlarge focused" id="focusedInput" type="text" name="first_name" value="<?php echo $admin_info->first_name; ?>" required>                                   
								</div>
							  </div>
                              ...
                              <div class="control-group warning">
								...
								<div class="controls">
								  <input class="input-xlarge focused" id="focusedInput" type="text" name="middle_name" value="<?php echo $admin_info->middle_name; ?>" />
                              ...
                              <div class="control-group">
								...
								<div class="controls">
								  <input class="input-xlarge focused" id="focusedInput" type="text" name="last_name" value="<?php echo $admin_info->last_name; ?>" required>                                   
								</div>
							  </div>
                              ...
                              <div class="control-group">
								...
								<div class="controls">
								  <input class="input-xlarge focused" id="focusedInput" type="number" name="mobile_no" value="<?php echo $admin_info->mobile_no; ?>" required>                                   
								</div>
							  </div>
                               ...
                               <div class="control-group">
								...
								<div class="controls">
								  <textarea class="input-xlarge focused" id="focusedInput" type="text" name="address" required><?php echo $admin_info->address; ?></textarea>                                   
								</div>
							  </div>
                               ...
                               <div class="control-group">
								...
								<div class="controls">
								  <input class="input-xlarge focused" id="focusedInput" type="text" name="pin_code" value="<?php echo $admin_info->pin_code; ?>" required>                                   
								</div>
							  </div>
                              ...
                              <div class="control-group">
								...
								<div class="controls">
								  <input class="input-xlarge focused" id="focusedInput" type="text" name="city" value="<?php echo $admin_info->city; ?>" required>                                   
								</div>
							  </div>
                               ...
                               <div class="control-group">
								...
								<div class="controls">
								  <input class="input-xlarge focused" id="focusedInput" type="text" name="state"  value="<?php echo $admin_info->state; ?>" required>                                   
								</div>
							  </div>
