...
<head>
  ...
  <meta name="author" content="Design: Pradeep Kumar www.bsmit.org.in / Author: MCA 6th sem student" />
...
$result=mysql_query("select seller.*,bid.* from seller,bid WHERE seller.buyerno=bid.buyerno GROUP BY seller.name");
 ...
 if(mysql_num_rows($result)>0)
          {
           ...
           echo '<tr>
                   <th class="top" scope="col">Seller Name	
                   <th class="top" scope="col">Price(Rs.)
                   <th class="top" scope="col">Discount
                   <th class="top" scope="col">Warranty
				   <th class="top" scope="col">FreeShipment
				   <th class="top" scope="col">Brand
				   <th class="top" scope="col">Size(GB)
				   <th class="top" scope="col">Quantity
				   <th class="top" scope="col">Delivery Date
           ...
           while($row=mysql_fetch_row($result))
             {
              ...
              echo '<td><center>'.$row[10].'</td>';
              echo '<td><center>'.$row[11].'</td>';
