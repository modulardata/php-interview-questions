...
<!---------------------------------------------------------->         
 ...
 <!--################################  PRIORITY TABLE  ####################################-->
       ...
       <form id="form1" name="form1" method=post
                      action="http://localhost/r/supplier_normalize.php">
...
foreach($arr as $row){
    ...
    mysql_query("INSERT INTO supplier_priority (supplier_1, supplier_2, supplier_3, supplier_4, supplier_5) VALUES({$row}) ") or die(mysql_error());
