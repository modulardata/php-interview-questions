...
<!--#####################################  PRIORITY TABLE  #################################-->
 ...
 <form id="form1" name="form1" method=post
       action="http://localhost/r/supplier_priority_submit.php">
     <table>
	 <tr><th class="top" scope="col">   </th><th class="top" scope="col">Supplier-1</th><th class="top" scope="col">Supplier-2</th><th class="top" scope="col">Supplier-3</th><th class="top" scope="col">Supplier-4</th><th class="top" scope="col">Supplier-5</th></tr>
	 
    <tr><th class="top" scope="col">Supplier-1</th>
    ...
    <tr><th class="top" scope="col">Supplier-2</th>
    ...
    <tr><th class="top" scope="col">Supplier-3</th>
    ...
    <tr><th class="top" scope="col">Supplier-4</th>
    ...
    <tr><th class="top" scope="col">Supplier-5</th>
