...
-->
  ...
  <title>Online Auction | Maximum Discount</title>
</head>
   ...
   <!-- For alternative headers START PASTE here -->
    ...
    <div class="header">
      ...
      <div class="header-top">
        ...
        <div class="nav1">
          <ul>
            <li><a href="../r/index.html" title="Go to Start page">Home</a></li>
            <li><a href="#" title="Get to know who we are">About</a></li>
            <li><a href="../r/Contact Us.php" title="Get in touch with us">Contact</a></li>																		
...
$result=mysql_query("select max(discount),seller.*,bid.* from seller,bid WHERE seller.bid_id=bid.bid_id");
