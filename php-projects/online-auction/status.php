...
<head>
  ...
  <title>Online Auction | Supplier Bid</title>
</head>
            ...
            <li><a href="#">Supplier<!--[if IE 7]><!--></a><!--<![endif]-->
              <!--[if lte IE 6]><table><tr><td><![endif]-->
                <ul>
				  ...
				  <li><a href="aftreNews.html">Futured Suppliers</a></li>
                </ul>
              <!--[if lte IE 6]></td></tr></table></a><![endif]-->
            </li>
          </ul> 
    ...
    <div class="main">
      ...
      <div class="main-navigation">
        ...
        <dl class="nav3-grid">
		  ...
		  <dt><a href="http://localhost/r/bid.php">Bid Status</a></dt>
      ...
      <div class="main-content">
        ...
        <!-- Pagetitle -->
        <h1 class="pagetitle">Bidding Zone</h1>
...
<!--<td valign="top" style="padding-left: 5px; text-align: justify;">-->
 ...
 <tr>
  ...
  <h5 align=right><font color=red><u> 
  <?php 
  echo $_SESSION['SESS_FIRST_NAME'];?></u></font></h5><br/>
...
$connection=mysql_connect('localhost','root') or die('unable to connect'); 
		...
		$seller_name1=$_SESSION['SESS_FIRST_NAME'];
   ?>
...
$result=mysql_query("select seller_id from mail where mail.bid_id ='$bid_id'");
	  
	  if ($result && mysql_num_rows($result) > 0) {
      $query_data=mysql_fetch_array($result);
      $seller_id=$query_data["seller_id"];
    }
 ...
 if($seller_id < 1 )
  {
	   ?>
		...
		<script type="text/javascript">
			 ...
			 document.write("<h5><font color=red>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;RESULT PENDING !!!</font></h5>");
	...
	echo "<html><p><b><font color=red>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;WINNER		  LIST</font></b></p></html>
	<html><p><b><font color=red>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;PRODUCT DETAILS</font></b></p></html>";
...
#####################  PRODUCT DETAILS  ##################
 ...
 $result=mysql_query("select bid.*,seller.* from seller,bid WHERE seller.bid_id=bid.bid_id AND seller.bid_id='$bid_id' AND seller.sellerno='$seller_id'");
...
if(mysql_num_rows($result)>0)
{
    echo '<center><table border=1>';
     echo '<tr>
			   ...
			   <th class="top" scope="col"><center>Rate</center>
			   <th class="top" scope="col"><center>Net Amount</center>
		</tr>';
     while($row=mysql_fetch_row($result))
     {
           ...
           echo '<td><center>'.$row[19].'</center></td>';
           echo '<td><center>'.$row[21].'</center></td>';
           echo '<td><center>'.$row[5].'</center></td>';
		   echo '<td><center>'.$row[18].'</center></td>';
		  // echo '<td><center>'.$row[14].'</td>';
    
	      $row[21]=($row[18]-($row[18]*$row[19]/100))*$row[5];
     ...
     {
      echo '<html><body><p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Result Pending</p></body></html>';
     }
...
echo '<html><p><b><font color=red><br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;SUPPLIER DETAILS</font></b></p></html>';


#####################  SUPPLIER DETAILS  ##################

 $result=mysql_query("select * from sellerl WHERE sellerl.sellerno='$seller_id'");

if(mysql_num_rows($result)>0)
{
    echo '<center><table border=1>';
     echo '<tr>
			   <th class="top" scope="col"><center>Supplier Id</center>
               <th class="top" scope="col"><center>Name</center>
			   <th class="top" scope="col"><center>Company<br/>Id</center>
			   <th class="top" scope="col"><center>Street</center>
			   <th class="top" scope="col"><center>Postal<br/>Code</center> 
			   <th class="top" scope="col"><center>Fax No</center>
			   <th class="top" scope="col"><center>Phone No</center>
			   <th class="top" scope="col"><center>City</center>
     ...
     while($row=mysql_fetch_row($result))
     {
		   ...
		   echo '<td><center>'.$row[21].'</center></td>';
           echo '<td><center>'.$row[15].'</center></td>';
           echo '<td><center>'.$row[16].'</center></td>';
           echo '<td><center>'.$row[7].'</center></td>';
           echo '<td><center>'.$row[18].'</center></td>';
		   echo '<td><center>'.$row[17].'</center></td>';
...
<!-- <form id="form1" name="form1" method=post  action="http://localhost/r/sellerbid.php">
     <tr>
        <td height="23"><div align="right"></div></td><br/><br/><br/>
        <td colspan="2"><span class="style3">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <br/><br/><br/></span></td>
        </tr>
      <tr>
         <td><div align="left"><span class="style3"><center>Bid ID :</td>
        <td><input name="bid_id" type="text" size="30" id="bid_id" value=""/></td></span></div>
     </tr></center>
	...
	<tr>
       ...
       <td><center><input name="submit" type="submit" accesskey="srch" value=" Submit " /></center></td>-->
