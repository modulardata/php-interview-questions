...
<!--#################################  PRIORITY TABLE  #################################-->
   ...
   $result=mysql_query("SELECT * from bid ORDER BY buyerno");
...
if(mysql_num_rows($result)>0)
{
    echo '<center><table border=1>';
     echo '<tr>
			   ...
			   <th class="top" scope="col"><center>Size</center>
     ...
     while($row=mysql_fetch_row($result))
     {
           ...
           echo '<td><center>'.$row[1].'</td></center>';
