...
<!---------------------------------------------------------->         
   ...
   <div class="main">
     ...
     <div class="main-content">
        ...
        <!-- Pagetitle -->
    <h1 class="pagetitle">Lead Time Priority Table</h1>
...
<?php
    ...
    $connection=mysql_connect('localhost','root') or die('unable to connect'); 
     mysql_select_db("corner");
	  ...
	  $result=mysql_query("select sum(price) as total_price from lead_time_priority");
 ...
 // echo "<p>The total sum price is $price_sum</p>";
       ...
       $result=mysql_query("select sum(lead_time) as total_leadtime from lead_time_priority");
  ...
  $result=mysql_query("select sum(free_shipment) as total_freeshipment from lead_time_priority");
  ...
  $result=mysql_query("select sum(discount) as total_discount from lead_time_priority");
 ...
 // echo "<p>The total lead time is $discount_sum</p>";
  ...
  $result=mysql_query("select sum(warranty) as total_warranty from lead_time_priority");
...
$result=mysql_query("select * from  lead_time_priority");
...
// as result2. 
$result2 = mysql_query("INSERT into lead_time_normalize(`price`,`lead_time`,`free_shipment`,`discount`,`warranty`,`lead_time_average`) VALUES('".$f6."','".$f7."','".$f8."','".$f9."','".$f10."','".$f11."')") or die(mysql_error());
...
$i++; 
   ...
   $result=mysql_query("select * from lead_time_normalize");
