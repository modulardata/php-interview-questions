...
<!---------------------------------------------------------->         
    ...
    <div class="main">
      ...
      <div class="main-content">
        ...
        <!-- Pagetitle -->
        <h1 class="pagetitle">Access Denied !!!</h1>
...
<form id="loginForm" name="loginForm" method=post action="http://localhost/r/login-exec.php"><!--<span class="style1"><a href="http://localhost/r/member-profile.php">My Profile</a> | <a href="http://localhost/r/logout.php">Logout</a></span>
<h5 class="style1">Welcome <?php 
                                    session_start();
echo $_SESSION['SESS_FIRST_NAME'];?></h5>-->
<p><h5 class="style1"><font color="red">This is a Password Protected Area </p>only Accessible to  Registered Members.</p></font></h5>
