...
class Roomsxml_Model extends CI_Model {
    ...
    function insert_booking_report_data($user_id, $CommitLevel, $Book_reference, $RefNo, $Booking_Date, $Book_hotelid, $Book_currency, $admin_markup, $payment_charge, $Book_totamnt, $total_price, $Book_Status, $Book_PayableBy, $Book_VoucherRef, $Booking_Done_By) {
        $data = array(
            'user_id' => $user_id,
            'agent_id' => '0',
    ...
    function insert_hotel_booking_information_data($RefNo, $Book_Hotelcode, $Book_HotelName, $city, $checkIn, $checkOut, $Booking_Date, $Book_RoomTypeval, $roomcount, $Book_Nights, $api, $adultvalue, $childvalue, $star, $image, $description, $address, $phone, $fax, $adultcount, $childcount, $user_id) {
        $data = array(
            'user_id' => $user_id,
            'agent_id' => '0',
            'RefNo' => $RefNo,
