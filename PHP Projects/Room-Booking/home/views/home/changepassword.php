                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form action="<?php echo WEB_URL; ?>user/change_password" enctype="multipart/form-data" method="post">
                                                            <label>Email id</label>
                                                            <input type="text" class="form-control form-group" placeholder="Email" name="" value="<?php echo $user_info->user_email ?>" readonly="">
