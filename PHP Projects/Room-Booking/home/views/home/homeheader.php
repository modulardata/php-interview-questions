    ...
    <!--                                                <li><a href="<?php echo WEB_URL; ?>">Dashboard</a></li>-->
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="nav">
                                <ul>
                                    <li><a href="<?php echo WEB_URL; ?>home/index" class="active">HOME</a></li>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form class="form-signin" role="form" action="<?php echo WEB_URL; ?>user/user_login" method="post">
                            ...
                            <p style="float:right;margin-top: 5px;"><a href="#" data-toggle="modal" data-target="#modalForgot">Forgot Password..?</a></p>
                            <br>
                        </form>
                    </div>
        ...
        <div class="modal fade" id="modalForgot" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form class="form-signin" role="form" action="<?php echo WEB_URL; ?>user/forgot_password" method="post">
