<form action="<?php echo WEB_URL; ?>hotel/hotel_search" method="post"> <div class="col-md-12">
                            ...
                            <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        ...
                                        <input type="text" class="form-control" id="hotelcity" placeholder="Enter a City" name="City" value="<?php echo $hotel_search_data['city']; ?>" required />
                                    </div>
                                    <div class="col-md-3">
