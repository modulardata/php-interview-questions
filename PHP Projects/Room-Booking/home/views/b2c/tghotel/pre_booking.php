<?php
echo $this->load->view('home/header');
?>
    ...
    <div class="container"> 
        ...
        <div class="row">
            <div class="col-md-12 bookedDetails">
                ...
                <form action="<?php echo WEB_URL; ?>dhotel/provisional_booking" method="post">
                                ...
                                <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="padd">
                                            ...
                                            <div class="col-md-4">
                                                <input type="text" value="<?php echo $user_email ?>" class="form-control" tabindex="143" maxlength="75" placeholder="Your booking details will be sent here" title="Enter your email id" id="userEmailId" name="userEmailId"  onblur="return email_validate(this.id);"/> 
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="padd">
                                            ...
                                            <div class="col-md-4">
                                                <input type="text" value="<?php echo $profile_data->mobile_no; ?>" class="form-control" tabindex="143" maxlength="10" placeholder="Enter Mobile Number" title="Enter Mobile Number" id="userMobilNo" name="userMobilNo"  onblur="return mobile_validate(this.id);"/> 
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                            ...
                                            <div class="col-md-4" >
                                                <select name="country" class="form-control" >
                                                    ...
                                                    foreach ($country as $val) {
                                                        ...
                                                        if (($val->iso3) == ($profile_data->country)) {
                                                            ?>
                                                            <option value="<?php echo $val->iso3; ?>" selected><?php echo $val->name; ?></option>
                                                            <?php
                                                        } else {
                                                            ?>
                                    ...
                                    <div class="row">
                                        <div class="padd">
                                            ...
                                            <div class="col-md-4">
                                                <input type="text" value="<?php echo $profile_data->city; ?>" class="form-control" placeholder="CITY" name="city" required /> 
                                    ...
                                    <div class="row">
                                        <div class="padd">
                                            ...
                                            <div class="col-md-4">
                                                <input type="text"  value="<?php echo $profile_data->pin_code; ?>" class="form-control" placeholder="POSTAL CODE" name="p_code" required /> 
                    ...
                    <section  id="travellerDetails" class="verySoftShadow">
                        <div class="bdOpen " id="travellersOpen">
                            ...
                            <div class="row ">
                                <div class="row">
                                    <div class="col-md-12"> 
                                    <p><input type="checkbox" name="agree" required checked="checked">I have read the Roombooking <a href="<?php echo WEB_URL; ?>home/terms_conditions" target="_blank">Terms and conditions</a> </input></p>
                                    </div>
                                </div>
