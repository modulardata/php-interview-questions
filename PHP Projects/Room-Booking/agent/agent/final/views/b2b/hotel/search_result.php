        ...
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="hotelResultsCntr">
                                    ...
                                    <div class="col-md-10 htlRightSection">
                                        <div class="row">
                                            <div class="col-md-8 htlDetailsCntr">
                                                ...
                                                <div ><p><?php echo substr($data->description, 0,300) .'...'; ?></p></div>
                                                <div class="htlprice">
                                                    <!--<i class="fa fa-rupee"></i>--><?php if ($data->api == 'hotelspro') echo 'USD'; else echo 'INR'; ?>  <?php echo $data->total_amount; ?>
                                            ...
                                            <div class="col-md-4 hotel-amenities">
                                                ...
                                                <div>
                                                    ...
                                                    <?php
                                                    if ($data->api == 'hotelspro') {
                                                        ?> 
                                                        <button class="btn btn-success pull-right">
                                                            <span class="showseat"><a style="color:white" href="<?php echo WEB_URL; ?>hotel/hotel_detail_int/<?php echo $data->hotel_search_result_info_id; ?>">BOOK ME </a></span> <i class="fa fa-hand-o-right"></i>
                                                        </button>
                                                        <?php
                                                    } else {
                                                        ?>
                                                        <button class="btn btn-success pull-right">
                                                            <span class="showseat"><a style="color:white" href="<?php echo WEB_URL; ?>hoteld/hotel_detail/<?php echo $data->hotel_search_result_info_id; ?>">BOOK ME </a></span> <i class="fa fa-hand-o-right"></i>
                                                        </button>
                                                        <?php
                                                    }
                                                    ?>
                    ...
                    <input type="hidden" id="setCurrency" value="<?php if ($api == 'hotelspro') echo 'USD'; else echo 'INR'; ?>." /> 
                </div>
            </div>
        </div>        
