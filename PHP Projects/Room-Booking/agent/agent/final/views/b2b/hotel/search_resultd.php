                                                ...
                                                <div>
                                                    <button class="btn btn-success pull-right">
                                                        ...
                                                        if ($data->api == 'hotelspro') {
                                                            ...
                                                            <span class="showseat"><a style="color:white" href="<?php echo WEB_URL; ?>hotel/hotel_detail_int/<?php echo $data->api_temp_hotel_id; ?>">BOOK ME </a></span> <i class="fa fa-hand-o-right"></i>
                                                            <?php
                                                        } else {
                                                            ?>
                                                            <span class="showseat"><a style="color:white" href="<?php echo WEB_URL; ?>hoteld/hotel_detail/<?php echo $data->api_temp_hotel_id; ?>">BOOK ME </a></span> <i class="fa fa-hand-o-right"></i>
                                                            <?php
                                                        }
                                                        ?>
