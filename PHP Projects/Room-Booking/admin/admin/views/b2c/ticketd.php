        ...
        <div class="ticket_container">
            <div class="ticket_title">
                <div class="ticket_logo" align="left">
                    <a href="<?php echo site_url(); ?>home/index"><div class="col-md-4 logo">
                    <img src="<?php echo site_url(); ?>public/img/logo.png" style="width:100%;height:60px;width:280px" alt="Roombooking">
                    </div></a>
                </div>
                <div class="support" align="right">
                    support@roombooking.in<br/>
                    +91 93425 29900
                </div>
            ...
            <div style="border:1px solid #CCC">
                <div class="ticket_details">
                    <p>
                        <strong>Dear <?php echo $hotel_details->lead_title ?>. <?php echo $hotel_details->lead_firstname ?></strong><br>
                ...
                <div class="traveler_details">
                    <table width="100%" align="center">
                        ...
                        <tr>
                            ...
                            <td><?php echo $hotel_details->lead_title ?>. <?php echo $hotel_details->lead_firstname ?></td>
            ...
            <div class="hotel_details">
                <table width="70%" cellspacing="5" cellpadding="5" align="justify">
                    <tr>
                        <th>Price</th>
                        <td> <?php echo $hotel_details->currency . ' ' . $hotel_details->total_price; ?></td>
                    </tr>
                </table> 
            ...
            <div class="hotel_details">
                <table width="60%" cellspacing="5" cellpadding="5">
                            <tr>
                                <td><?php echo $hotel_details->lead_title ?></td>
                                <td><?php echo $hotel_details->lead_firstname ?></td>
                               <td><?php echo $hotel_details->lead_lname ?></td>
                            </tr>
            ...
            <div class="hotel_details" align="center">
                <a href="<?php echo site_url(); ?>">Home</a> <a href="#" onclick="myFunction()">Print</a>
            </div>
