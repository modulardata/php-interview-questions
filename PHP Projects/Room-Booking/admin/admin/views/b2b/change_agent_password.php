			...
			<div class="row-fluid">
				<div class="span12">
                    ...
                    <?php if(!empty($agent_info)) {?>
						<form class="form-horizontal" action="<?php echo site_url();?>/b2b/change_agent_password/<?php echo $agent_id; ?>" method="post">
							<fieldset>
                            <?php
							  	if($status == '1')
								{
								...
								<button class="close" data-dismiss="alert" type="button">×</button>
									<strong>Success!</strong>
									 Agent Password Successfully Reseted.
								</div>
								<?php 
								}
								if(!empty($errors))
                          ...
                          <?php } ?> 
							 ...
							 <div class="form-actions">
								...
								<a href="<?php echo site_url();?>/b2b/view_agent_info/<?php echo $agent_id; ?>" title="Click here to go back" data-rel="tooltip" class="btn btn-warning">Cancel</a>
							  </div>
