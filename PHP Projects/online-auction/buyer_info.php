...
<!--#################################  PRIORITY TABLE  #################################-->
   ...
   $result=mysql_query("SELECT bid.bid_id,bid.buyerno,bid.name,count(*) as no_of_bid FROM buyer,bid WHERE bid.buyerno=buyer.buyerno GROUP BY bid.name");
...
if(mysql_num_rows($result)>0)
{
    echo '<center><table border=1>';
     echo '<tr>
               ...
               <th class="top" scope="col"><center>No of<br/>Requirement(s)</center>
...
<form id="form1" name="form1" method=post  action="http://localhost/r/buyer_info_full.php">
<br/><br/>
 <center><input name="submit" type="submit" accesskey="srch" value=" Get Full Information " />
</center>
