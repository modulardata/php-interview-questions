...
<form name="myform">
 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp<input type="text" id="txt" size=4 />
...
<!---------------------------------------------------------->         
 ...
 <!--################################  PRIORITY TABLE  ####################################-->
       ...
       <form id="form1" name="form1" method=post
                      action="http://localhost/r/lead_time_normalize.php">
...
//Row-wise insertion using Array
...
$arr = Array(
    ...
    0 => Array
        ...
        (
            ...
            1 => $lead_time=$_POST['lead_time01'],

            2 => $free_shipment=$_POST['free_shipment02'],

            3 => $discount=$_POST['discount03'],

			4 => $warranty=$_POST['warranty04'],
    ...
    1 => Array
        ...
        (
            ...
            0 => $lead_time=1/$_POST['lead_time01'],

            1 => "1",

            2 => $free_shipment=$_POST['free_shipment12'],

            3 => $discount=$_POST['discount13'],

			4 => $warranty=$_POST['warranty14'],
    ...
    2 => Array
        ...
        (
            ...
            0 => $price=1/$_POST['free_shipment02'],

            1 => $lead_time=1/$_POST['free_shipment12'],

            2 => "1",

            3 => $discount=$_POST['discount23'],

			4 => $warranty=$_POST['warranty24'],
    ...
    3 => Array
        ...
        (
            ...
            0 => $price=1/$_POST['discount03'],

            1 => $lead_time=1/$_POST['discount13'],

            2 => $free_shipment=1/$_POST['discount23'],

            3 => "1",

			4 => $warranty=$_POST['warranty34'],
    ...
    4 => Array
        ...
        (
            ...
            0 => $price=1/$_POST['warranty04'],

            1 => $lead_time=1/$_POST['warranty14'],

            2 => $free_shipment=1/$_POST['warranty24'],

            3 => $discount=1/$_POST['warranty34'],
...
foreach($arr as $row){
    ...
    //5  is the highest key in each sub-array
    ...
    mysql_query("INSERT INTO lead_time_priority (price, lead_time, free_shipment, discount, warranty) VALUES({$row}) ") or die(mysql_error());
...
<br/><br/><center><input name="Submit" type="submit" accesskey="srch" value=" Normalize It " /></center>
