...
<!---------------------------------------------------------->         
    ...
    <div class="main">
      ...
      <div class="main-content">
        ...
        <!-- Pagetitle -->
        <h1 class="pagetitle">Administrator Registration Form</h1>
...
?>
 ...
 <form id="loginForm" name="loginForm" method=post action="http://localhost/r/aregister-exec.php">
          ...
          <div class="contactform">
            ...
            <fieldset><legend>&nbsp;CONTACT DETAILS&nbsp;</legend>
               <p><label for="contact_title" class="left">Title:</label>
				  ...
				  <p><label for="lastname" class="left">Surname:</label>
