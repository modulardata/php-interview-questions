...
<!--#####################################  PRIORITY TABLE  #################################-->
 ...
 <form id="form1" name="form1" method=post
       action="http://localhost/r/lead_time_priority_submit.php">
     <table>
	 <tr><th class="top" scope="col">   </th><th class="top" scope="col">Price</th><th class="top" scope="col">Lead Time</th><th class="top" scope="col">Free-shipment</th><th class="top" scope="col">Discount</th><th class="top" scope="col">Warranty</th></tr>
	 
    <tr><th class="top" scope="col">Price</th>
    <td><center>1</center></td>
	
	<td><center><select name='lead_time01'>
	...
	<td><center><select name='free_shipment02'>
           <option value='1' selected>1</option>
	       <option value='2' selected>2</option>
	       <option value='3' selected>3</option>
           <option value='4' selected>4</option>
	...
	<td><center><select name='discount03'>
           <option value='1' selected>1</option>
	       <option value='2' selected>2</option>
	       <option value='3' selected>3</option>
           <option value='4' selected>4</option>
	...
	<td><center><select name='warranty04'>
           <option value='1' selected>1</option>
	       <option value='2' selected>2</option>
	       <option value='3' selected>3</option>
           <option value='4' selected>4</option>
    ...
    <tr><th class="top" scope="col">Lead Time</th>
    <td> </td><td><center>1<center></td>
	<td><center><select name='free_shipment12'>
           <option value='1' selected>1</option>
	       <option value='2' selected>2</option>
	       <option value='3' selected>3</option>
           <option value='4' selected>4</option>
	...
	<td><center><select name='discount13'>
           <option value='1' selected>1</option>
	       <option value='2' selected>2</option>
	       <option value='3' selected>3</option>
           <option value='4' selected>4</option>
	...
	<td><center><select name='warranty14'>
           <option value='1' selected>1</option>
	       <option value='2' selected>2</option>
	       <option value='3' selected>3</option>
           <option value='4' selected>4</option>
    ...
    <tr><th class="top" scope="col">Free-Shipment</th>
    <td>  </td><td>  </td><td><center>1</center></td>
	<td><center><select name='discount23'>
           <option value='1' selected>1</option>
	       <option value='2' selected>2</option>
	       <option value='3' selected>3</option>
           <option value='4' selected>4</option>
	...
	<td><center><select name='warranty24'>
           <option value='1' selected>1</option>
	       <option value='2' selected>2</option>
	       <option value='3' selected>3</option>
           <option value='4' selected>4</option>
    ...
    <tr><th class="top" scope="col">Discount</th>
    <td>  </td><td>  </td><td>  </td><td><center>1</center></td>
	<td><center><select name='warranty34'>
           <option value='1' selected>1</option>
	       <option value='2' selected>2</option>
	       <option value='3' selected>3</option>
           <option value='4' selected>4</option>
    ...
    <tr><th class="top" scope="col">Warranty</th>
    <td>  </td><td>  </td><td>  </td><td>  </td><td><center>1</center></td></tr>   

</table>
         
	<br/><br/><center><input name="Submit" type="submit" accesskey="srch" value="submit" /></center>
</div>    
