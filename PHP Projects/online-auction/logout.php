...
<head>
  ...
  <title>Online Auction | Logout</title>
</head>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<script src="script.js" type="text/javascript" align="right"></script></center>
...
<!---------------------------------------------------------->         
      ...
      <div class="header-breadcrumbs">
        <ul>
          ...
          <li><a href="http://locahost/r/Contact Us.php">Contact&nbsp;</a></li>
    ...
    <div class="main">
      ...
      <div class="main-content">
        ...
        <!-- Pagetitle -->
        <h1 class="pagetitle">Thanks for Visiting Our Site !!!</h1>

<!--####################   LOGOUT PAGE  ########################-->

 <div class="column1-unit"><br/><table><tr>
<!--<td valign="top" style="padding-left: 5px; text-align: justify;"></td>-->
                                    
 <form id="loginForm" name="loginForm" method=post action="http://localhost/r/login-exec.php">
 <!--<h4 class="style1">--><font color=red><!--<td align=left> </font></i></u></td>-->
<h5 align="center" class="err style1"><u><i>You have been logged out.</u></i></h5>
<p align="center" class="style1">CLICK HERE TO GO <a href="http://localhost/r/index.html">Home Page</a></p>
</form></font>
 </tr></table></div></div>   
