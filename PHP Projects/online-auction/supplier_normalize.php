...
<!---------------------------------------------------------->         
   ...
   <div class="main">
     ...
     <div class="main-content">
        ...
        <!-- Pagetitle -->
    <h1 class="pagetitle">Supplier Priority Table</h1>
...
<?php
    ...
    $connection=mysql_connect('localhost','root') or die('unable to connect'); 
     mysql_select_db("corner");
	  ...
	  $result=mysql_query("select sum(supplier_1) as total_price from supplier_priority");
 ...
 // echo "<p>The total sum price is $price_sum</p>";
       ...
       $result=mysql_query("select sum(supplier_2) as total_leadtime from supplier_priority");
  ...
  $result=mysql_query("select sum(supplier_3) as total_freeshipment from supplier_priority");
  ...
  $result=mysql_query("select sum(supplier_4) as total_discount from supplier_priority");
 ...
 // echo "<p>The total lead time is $discount_sum</p>";
  ...
  $result=mysql_query("select sum(supplier_5) as total_warranty from supplier_priority");
...
$result=mysql_query("select * from  supplier_priority");
...
// to the row. 
$f1=mysql_result($result,$i,"supplier_1"); 
$f2=mysql_result($result,$i,"supplier_2"); 
$f3=mysql_result($result,$i,"supplier_3"); 
$f4=mysql_result($result,$i,"supplier_4");
$f5=mysql_result($result,$i,"supplier_5"); 
...
// as result2. 
$result2 = mysql_query("INSERT into supplier_normalize(`supplier_1`,`supplier_2`,`supplier_3`,`supplier_4`,`supplier_5`,`supplier_average`) VALUES('".$f6."','".$f7."','".$f8."','".$f9."','".$f10."','".$f11."')") or die(mysql_error());
...
$i++; 
   ...
   $result=mysql_query("select * from supplier_normalize");

if(mysql_num_rows($result)>0)
{
    echo '<center><table border=1>';
     echo '<tr>
			   <th class="top" scope="col"><center>Supplier-1</center>
			   <th class="top" scope="col"><center>Supplier-2</center>
               <th class="top" scope="col"><center>Supplier-3</center>
			   <th class="top" scope="col"><center>Supplier-4</center>
			   <th class="top" scope="col"><center>Supplier-5</center>
