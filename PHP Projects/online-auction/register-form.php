...
<head>
  ...
  <title>Online Auction | Buyer Registration</title>
</head>
...
<form name="myform"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" id="txt" size=4 />
...
<!---------------------------------------------------------->         
    ...
    <div class="main">
      ...
      <div class="main-content">
        ...
        <!-- Pagetitle -->
        <h1 class="pagetitle">Buyer Registration Form</h1>
...
?>
 ...
 <form id="loginForm" name="loginForm" method=post action="http://localhost/r/register-exec.php">
          ...
          <div class="contactform">
            ...
            <fieldset><legend>&nbsp;CONTACT DETAILS&nbsp;</legend>
               <p><label for="contact_title" class="left">Title:</label>
				...
				<p><label for="lastname" class="left">Last name:</label>
                   <input type="text" name="lname" id="lname" class="field" value="" tabindex="1" /></p>
				<p><label for="login" class="left">Login Id:</label>
				...
				<p><label for="cpassword" class="left">Confirm     Password:</label>
                ...
                <p><label for="phoneno" class="left">Phone No:</label>
                   <input type="text" name="phoneno" id="phoneno" class="field" value="" tabindex="2" maxlength=10 /></p>
                <p><label for="emailid" class="left">Email Id:</label>
                   <input type="text" name="emailid" id="emailid" class="field" value="" tabindex="2" /></p>
             
              </fieldset>
             
			 <input type="submit" name="submit" id="submit" class="button" value="Submit Form" tabindex="1"/><br/><br/><br/>
            </form>
          </div>              
        </div>   
   </div>
