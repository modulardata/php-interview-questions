...
<head>
  ...
  <title>Online Auction | Login Unsuccessful</title>
</head>
            ...
            <li><a href="#">Buyer<!--[if IE 7]><!--></a><!--<![endif]-->
              <!--[if lte IE 6]><table><tr><td><![endif]-->
                <ul>
                  ...
                  <li><a href="#">Search for Supplier</a></li>
				  <li><a href="#">Buyer Benefits</a></li>
            ...
            <li><a href="#">Supplier<!--[if IE 7]><!--></a><!--<![endif]-->
              <!--[if lte IE 6]><table><tr><td><![endif]-->
                <ul>
				  ...
				  <li><a href="#">Futured Suppliers</a></li>
                </ul>
              <!--[if lte IE 6]></td></tr></table></a><![endif]-->
            </li>
          </ul> 
...
<!---------------------------------------------------------->         
    ...
    <div class="main">
      ...
      <div class="main-navigation">
        ...
        <dl class="nav3-grid">
          <dt><a href="../r/Administrator Login.html">Administrator Login</a></dt>
          <dt><a href="../r/Supplier Login">Supplier Login</a></dt>
      ...
      <div class="main-content">
        ...
        <!-- Pagetitle -->
        <h1 class="pagetitle">Online Auction </h1>
...
<td valign="top" style="padding-left: 5px; text-align: justify;">
		...
		<form id="loginForm" name="loginForm" method=post action="http://localhost/r/login-exec.php">
			  <h2 class="style1"><font color=red>Login Failed !!! </font></h2>
			  <p align="center">&nbsp;</p>
			  <h5 align="center" class="err style1">Login Failed!<br />
			    Please check your username or password</h5>
			</form>							
