...
function reload()
{
	document.frm.action='Marks_Attendance2.php';
	document.frm.submit();
...
?>		<table width="50%" align="center" class="forumline" border="1" cellspacing="0" cellpadding="0">
  <tr>
    <td colspan="2" align="center" class="head">SEND MARKS TO PARRENTS</td>
    </tr>
...
<br>
<div align="center"><input type="button" name="open" value="Send MSG" onClick="reload1()"></div>				
</form>	
</body>
</html>
