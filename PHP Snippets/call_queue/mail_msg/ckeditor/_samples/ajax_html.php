   <?php
	 include("../../../db.php");
	 $id=$_REQUEST['id'];
$qury=mysql_fetch_row(mysql_query("select mail_subject, mail_content  FROM `mail_det` where id='$id'"));
$mail_boday=$qury[1];
$mail_subject=$qury[0];
?>
...
<body class="samplebody">
    ...
    <strong>Subject</strong> &nbsp;&nbsp;&nbsp;&nbsp;
      <input type="text" width="70" id="subject" name="subject" size="70" maxlength="70" max="70" value="<?php echo $mail_subject; ?>" />
      <input type="hidden" width="70" id="modify" name="modify" size="70" maxlength="70" max="70" value="<?php echo $id; ?>" />
