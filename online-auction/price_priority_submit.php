...
<!---------------------------------------------------------->         
 ...
 <!--################################  PRIORITY TABLE  ####################################-->
       ...
       <form id="form1" name="form1" method=post
                      action="http://localhost/r/price_normalize.php">
...
foreach($arr as $row){
    ...
    mysql_query("INSERT INTO price_priority (price, lead_time, free_shipment, discount, warranty) VALUES({$row}) ") or die(mysql_error());
