...
<!--###########################   SUPPLIER INFORMATION TABLE   ############################-->
   ...
   $result=mysql_query("SELECT seller . * , COUNT( * ) AS no_of_bid FROM seller
...
if(mysql_num_rows($result)>0)
{
    echo '<center><table border=1>';
     echo '<tr>
			   <th class="top" scope="col"><center>Seller Bid Id</center>
			   ...
			   <th class="top" scope="col"><center>No of Bids</center>
...
<form id="form1" name="form1" method=post  action="http://localhost/r/supplier_info_full.php">
<br/><br/>
