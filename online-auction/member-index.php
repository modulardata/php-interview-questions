...
<head>
  ...
  <title>Online Auction | Buyer Login</title>
</head>
...
<!--<form id="loginForm" name="loginForm" method=post action="http://localhost/r/login-exec.php"><span class="style1"><a href="http://localhost/r/member-profile.php"></a>  <a href="http://localhost/r/logout.php"> </a></span>-->
 <p class<h1 class="style1"><b><font color=red><u><center> 
  <?php 
