...
<!---------------------------------------------------------->         
 ...
 <!--################################  PRIORITY TABLE  ####################################-->
       ...
       <form id="form1" name="form1" method=post
                      action="http://localhost/r/free_shipment_normalize.php">
...
foreach($arr as $row){
    ...
    mysql_query("INSERT INTO free_shipment_priority (price, lead_time, free_shipment, discount, warranty) VALUES({$row}) ") or die(mysql_error());
