...
<!--###################    REGISTRATION SUCESSFUL PAGE    #################-->


<div class="column1-unit"><br/><table><tr>
<td valign="top" style="padding-left: 5px; text-align: justify;">
                                    
 <form id="loginForm" name="loginForm" method=post action="http://localhost/r/alogin-exec.php">
			
<h1 class="style1"><font color=red><b><i>
<u>Registration Successful</u>
</b></i></font></h1>
 <p class="style1"><a href="http://localhost/r/Administrator Login.html">Click here</a> to login to your account.</p>
</form>
</td></tr></table></div></div>
