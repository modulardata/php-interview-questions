...
<!---------------------------------------------------------->         
   ...
   <div class="main">
     ...
     <div class="main-content">
        ...
        <!-- Pagetitle -->
    <h1 class="pagetitle">Attribute Matrix Table</h1>
...
<!--###############################  MATRIX TABLE  ####################################-->
       ...
       <!-- <div class="column1-unit">-->          
        ...
        <!-- Content unit - One column -->
        <h1 class="block">Matrix Table</h1>
       <div class="column1-unit">
<?php
...
$result=mysql_query("INSERT into matrix  SELECT  price_average,lead_time_average,free_shipment_average,discount_average,warranty_average
FROM  
price_normalize,lead_time_normalize,free_shipment_normalize,discount_normalize,warranty_normalize WHERE
price_normalize.price_id = lead_time_normalize.lead_time_id
AND lead_time_normalize.lead_time_id = free_shipment_normalize.free_shipment_id
AND free_shipment_normalize.free_shipment_id = discount_normalize.discount_id
AND discount_normalize.discount_id = warranty_normalize.warranty_id");

  

   $result=mysql_query("select * from matrix");

if(mysql_num_rows($result)>0)
{
    echo '<center><table border=1>';
     echo '<tr>
			   <th class="top" scope="col"><center>Average Price</center>
			   <th class="top" scope="col"><center>Average Lead Time</center>
               <th class="top" scope="col"><center>Average Free-Shipment</center>
			   <th class="top" scope="col"><center>Average Discount</center>
			   <th class="top" scope="col"><center>Average Warranty</center>
