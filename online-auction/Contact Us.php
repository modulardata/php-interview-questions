...
<head>
  ...
  <title>Online Auction | Administrator Registration Form</title>
</head>
...
?>
 ...
 <form id="loginForm" name="loginForm" method=post action="http://localhost/r/Contact Us-exec.php">
           ...
           <!-- <form method="post" action="index.html">-->
			...
			<p><label for="company" class="left">Company</label>
                ...
                <p><label for="contact_title" class="left">Title:</label>
                 ...
                 <p><label for="firstname" class="left">First name:</label>
                   <input type="text" name="fname" id="fname" class="field" value="" tabindex="1" /></p>
				
                 <p><label for="fyname" class="left">Family name:</label>
                   <input type="text" name="fyname" id="fyname" class="field" value="" tabindex="1" /></p>
              
			    <p><label for="address" class="left">Address:</label>
                   <input type="text" name="address" id="address" class="field" value="" tabindex="1" /></p>
                <p><label for="phoneno" class="left">Phone No:</label>
                   <input type="text" name="phoneno" id="phoneno" class="field" value="" tabindex="1" /></p>
				
                <p><label for="emailid" class="left">Email Id:</label>
                   <input type="text" name="emailid" id="emailid" class="field" value="" tabindex="1" /></p>
              ...
              <fieldset><legend>&nbsp;MESSAGE DETAILS&nbsp;</legend>
                ...
                <textarea name="message" id="message" cols="45" rows="10"tabindex="1"></textarea></p>
                <p><input type="submit" name="submit" id="submit" class="button" value="Send message" tabindex="1" /></p>
              </fieldset>
...
<!---------------------------------------------------------------------------->
 ...
 <!-- B.3 SUBCONTENT -->
    ...
    <div class="footer">
      ...
      <p class="credits">Original design by : <a href="http://www.bmsit.org" title="Designer Homepage">Pradeep Kumar</a> | USN : <a href="http://www.bmsit.org" title="Designer Homepage">1BY09MCA28</a></p>
    </div>      
  </div> 
</body>
</html>
