...
<!--###########################   SUPPLIER INFORMATION TABLE   ############################-->
       ...
       <h1 class="block">Supplier Table</h1>
   ...
   $result=mysql_query("SELECT * FROM sellerl ORDER BY sellerno");
...
if(mysql_num_rows($result)>0)
{
    echo '<center><table border=1>';
     echo '<tr>
			   ...
			   <th class="top" scope="col"><center>Organization<br/>Type</center>
               <th class="top" scope="col"><center>Experience<br/>(Yr)</center>
			   <th class="top" scope="col"><center>Clients</center>
			   <th class="top" scope="col"><center>Certified</center>
			   <th class="top" scope="col"><center>Profit<br>(Yr)(lakh)</center>
			   <th class="top" scope="col"><center>Production<br/>Capacity(Yr)</center>
     ...
     while($row=mysql_fetch_row($result))
     {
           ...
           echo '<td><center>'.$row[24].'</td>';
		   echo '<td><center>'.$row[25].'</td>';
           echo '<td><center>'.$row[26].'</td>';
		   echo '<td><center>'.$row[27].'</td>';
		   echo '<td><center>'.$row[28].'</td>';
