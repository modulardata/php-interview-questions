...
-->
  ...
  <title>Online Auction | Bid Status</title>
  <link rel="stylesheet" href="vertical-text.css" type="text/css" media="all" />
</head>
      ...
      <div class="main-navigation">
        ...
        <dl class="nav3-grid">
         <!-- <dt><a href="http://localhost/r/product.php">Post new bid</a></dt>
		  ...
		  <dt><a href="http://localhost/r/supplier_info_full.php">Go Back</a></dt>
...
<!--<td valign="top" style="padding-left: 1px; text-align: justify;">-->
...
$result=mysql_query("select seller.*,bid.* from seller,bid WHERE bid.bid_id='$bid_id' AND seller.bid_id=bid.bid_id GROUP BY seller.name");
 ...
 if(mysql_num_rows($result)>0)
          {
           ...
           while($row=mysql_fetch_row($result))
             {
              echo '<tr>';
              echo '<td><center>'.$row[2].'</td></center>';
              echo '<td><center>'.$row[4].'</td></center>';
              echo '<td><center>'.$row[12].'</td></center>';
          ...
          //$row[15]=(($row[3]-($row[3]*$row[4]/100))*$row[11];
			...
			$row[21]=($row[5]-($row[5]*$row[6]/100))*$row[14];
...
<td><center><input name="discount" type="submit" value="  Max Discount  " /></center></td></form> </tr>-->
