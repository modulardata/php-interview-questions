...
<head>
  ...
  <title>Online Auction | Supplier Login</title>
</head>
...
<!---------------------------------------------------------->         
      ...
      <div class="header-breadcrumbs">
        ...
        <div class="searchform">
          <form action="http://google.com" method="get" class="form">
            <fieldset>
    ...
    <div class="main">
      ...
      <div class="main-content">
        ...
        <!-- Pagetitle -->
        <h1 class="pagetitle">Online Auction Overview</h1>
...
<td valign="top" style="padding-left: 5px; text-align: justify;">
 ...
 <form id="loginForm" name="loginForm" method=post action="http://localhost/r/slogin-exec.php"><span class="style1"><a href="http://localhost/r/smember-profile.php"></a>  <a href="http://localhost/r/logout.php"> </a></span>
 <p class<h1 class="style1"><b><font color=red><u><center>Welcome Supplier 
  <?php 

  echo $_SESSION['SESS_FIRST_NAME'];?></u></font></b><p></p></center> <br />
<br />
<br />
 <a href="http://localhost/r/product.php">Buyer Requirement Option</a>
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a href="http://localhost/r/add.php">  </a>	   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a href="http://localhost/r/addsupplier.php"> </a>
   <p>&nbsp;</p>
</form>
</td></tr></table></div></div>
