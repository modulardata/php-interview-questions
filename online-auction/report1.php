...
-->
  ...
  <title>Online Auction | Freeshipment</title>
</head>
...
$result=mysql_query("select seller.*,bid.* from seller,bid WHERE seller.bid_id=bid.bid_id AND freeshipment like 'Yes' GROUP BY seller.name;");
...
<td><center><input name="freeshipment" type="submit" value="  Least Cost  " /></center></form></td>
