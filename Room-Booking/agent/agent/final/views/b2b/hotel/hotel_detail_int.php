...
<!--                                                                <a class="htl-ind-rm-dtls">VIEW DETAILS <i class="fa fa-caret-down"></i></a> -->
                                                ...
                                                <div class="col-md-3 htl-rm-price"> <span><i class="fa fa-rupee"></i><?php echo $service->total_cost; ?></span> <span class="font12">(all incl. )</span>
                                                    <div>
                                                        <form action="<?php echo WEB_URL; ?>hotel/pro_pre_booking/<?php echo $service->api_temp_hotel_id ?>" method="post">
                                                            <input type="hidden" name="roomid" value="<?php echo $service->api_temp_hotel_id; ?>" />
                                                            <input type="hidden" name="rateplancode" value="<?php echo ' '; ?>" />
                                                            <input type="hidden" name="hotel_code" value="<?php echo $service->hotel_code; ?>" />
                                                            <input type="hidden" name="hotel_search_id" value="<?php echo $service->api_temp_hotel_id; ?>" />
                                                            <input type="hidden" name="net_rate" value="<?php echo $service->total_cost; ?>" />
                                                            <input type="hidden" name="tax" value="<?php echo ' '; ?>" />
