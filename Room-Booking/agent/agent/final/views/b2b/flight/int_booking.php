        ...
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="hotelResultsCntr"> 
                    <form action="<?php echo WEB_URL; ?>flight/confirm_int_booking" name="passengerForm" method="post" onsubmit="return formValidate();">
                                        ...
                                        if ($flight_result != '') {
                                            ...
                                            for ($i = 0; $i < count($Departure_Code); $i++) {
                                                ...
                                                <?php if ($Arrival_Code[$i] != $Destination) { ?> 
                                                    ...
                                                    ?>
                                                    <div class="layover "><span>Layover:<span class="layover-dur">Change planes at <?php echo $Arrival_CityName[$i]; ?>. Layover: <?php echo $this->Flight_Model->journeyDuration($ArrDateTime, $DepDateTime); ?></span></span></div>
                                                <?php } ?>
                                            <?php } ?>
                                        <?php } ?>
                                                ...
                                                <div class="results-row font12">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-3 air-dep-time"> 
                                                            ...
                                                            <span><?php echo date('D, j M', strtotime($DDate_r)); ?> | <strong><?php echo date('H:i', strtotime($DTime_r)); ?></strong></span> 
                                                        ...
                                                        <div class="col-md-3 air-arv-time"> 
                                                            ...
                                                            <span><?php echo $Arrival_CityName[$i]; ?>&nbsp;<?php if ($Arrival_Terminal_r != '') echo 'T-' . $Arrival_Terminal_r[$i]; ?></span> </div>
                                ...
                                <div class="bk_frbrp">
                                    ...
                                    <div class="fare_row">
                                        ...
                                        <dl class="summary">
                                            ...
                                            <dd>Rs. <?php echo $PassengerBaseFare[0] * $Adults; ?></dd>
                                            <?php if ($Childs != '' && $Childs != 0) { ?>  
                                                <dt>Child x <?php echo $Childs; ?> </dt>
                                                <dd>Rs. <?php echo $PassengerBaseFare[1] * $Childs; ?></dd>
                                            <?php } ?>
                                            <?php if ($Infants != '' && $Infants != 0) { ?> 
                                                <dt>Infant x <?php echo $Infants; ?></dt>
                                                <dd>Rs.  <?php echo $PassengerBaseFare[2] * $Infants; ?>
                                                <?php } ?>
                                        </dl>
                                    </div>
                                    <div class="fare_row">
                                        ...
                                        <dl class="summary">
                                            ...
                                            <dd> Rs.  <?php echo array_sum($Tax_Amount) + $flight_result->Admin_Markup + $flight_result->Agent_Markup; ?></dd>
                                    ...
                                    <div class="fare_row">
                                        <dl class="summary">
                                            ...
                                            <dd class="fare_toatl"> <b> <?php echo $flight_result->TotalFare + $flight_result->Admin_Markup + $flight_result->Agent_Markup; ?>
                                                </b></dd>
                                        </dl>
                                    </div>
                                </div>
