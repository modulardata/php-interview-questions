...
class Hotel extends CI_Controller {
    ...
    public function backtosearch() {
        ...
        $this->load->view('b2b/hotel/search_progress', $data);
    }
...
//            exit;
    ...
    function hotel_detail_int($hotel_id) {
        ...
        if ($hotel_detail->api == 'hotelspro') {
            ...
            //echo '<pre>'; print_r($data);exit;
            $this->load->view('b2b/hotel/hotel_detail_int', $data);
            //}
        }
    }
...
//            exit;
            ...
            $this->load->view('b2b/hotel/pro_pre_booking_int', $data);
        }
    }
...
//              print_r($getHotelCancellationPolicy); exit;
              ...
              ' . $cancelamount2 . ' ' . $val1[1] . ' Charges Will Apply';
                ...
                $this->load->view('b2b/hotel/pre_booking_int', $data);
            }
...
//        print_r($data);
//        exit;
        $this->load->view('b2b/hotel/ticket', $data);
//       
    }
