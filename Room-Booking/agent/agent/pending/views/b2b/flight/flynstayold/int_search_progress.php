...
function call()
{	
	document.intSearchProgress.submit();
}
...
<body onload="call()">
<form name="intSearchProgress" action="<?php print WEB_URL; ?>flight/int_search_progress" onSubmit="return ray.ajax()" method="post">
                    ...
                    <td align="center">
                        ...
                        <table width="50%" cellspacing="5" cellpadding="5" border="0" bgcolor="#bebebe">
                           ...
                           <?php 
							...
							?>
                                <tr bgcolor="#ffffff" >
                                    <td><?php echo $session_data['originCity'];?> </td>
                                    <td><?php echo $session_data['destinationCity'];?></td>
                                    <td>
									<?php 
