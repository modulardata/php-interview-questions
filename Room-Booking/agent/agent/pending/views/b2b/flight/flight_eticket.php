                            ...
                            <tr>
                                <td width="230" align="center" height="90">
                                    <a href="<?php echo WEB_URL; ?>home">
                                        <img src="<?php echo WEB_DIR; ?>public/img/logo.png" border="0" />
                                    </a>
                                </td>
                                <td class="inputtext"><div align="right"><b>Support Number:</b>&nbsp;+91-1234567890<br/>
                                        +91-1234567890<br>
                                            <b>Email:</b>&nbsp;info@tickmango.in</div></td>
                            </tr>
                        </table></td>
                </tr>
                <tr>
                    <td width="979">
                        <table width="98%" align="center" border="0" cellpadding="0" cellspacing="0"  style="border:1px solid #CCCCCC; padding: 1%">
                            <tr>
                            ...
                            <tr>
                                <td class="inputtext"><p style="margin-left:10px;">Dear <b><?php echo $passenger_info[0]->title . ' ' . $passenger_info[0]->first_name . ' ' . $passenger_info[0]->middle_name . ' ' . $passenger_info[0]->last_name; ?></b>,
                                        ...
                                        Your booking for Flight is confirmed. Your tickmango Reference Number is <b><?php echo $booking_info->tickmangoRefNo; ?></b> Please
                            ...
                            <tr>
                                <td valign="top"><table  style="margin-left: 10px;" width="98%" border="0" cellpadding="2" cellspacing="0">
                                        <tr bgcolor="#f5f9fc">
                                            <td width="37%" align="left" height="25"><div class="hoteltext" align="left"><strong>Transaction </strong></div></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><div class="normal" align="left">			
                                                    ...
                                                    if (isset($booking_info_return) && $booking_info_return != '') {
                                                        ...
                                                        echo array_sum($Tax_Amount) + $booking_info->Admin_Markup + $booking_info->Payment_Charge + array_sum($Tax_Amount_r) + $booking_info_return->Admin_Markup + $booking_info_return->Payment_Charge;
                                                    } else {
                                                        echo array_sum($Tax_Amount) + $booking_info->Admin_Markup + $booking_info->Payment_Charge;
                                                    }
                                                    ?>
                                                </div></td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td><div class="normal" align="left">
                                                    <?php
                                                    if (isset($booking_info_return) && $booking_info_return != '')
                                                        echo $booking_info->TotalFare + $booking_info->Admin_Markup + $booking_info->Payment_Charge + $booking_info_return->TotalFare + $booking_info_return->Admin_Markup + $booking_info_return->Payment_Charge;
                                                    else
                                                        echo $booking_info->TotalFare + $booking_info->Admin_Markup + $booking_info->Payment_Charge;
                                                    ?>
