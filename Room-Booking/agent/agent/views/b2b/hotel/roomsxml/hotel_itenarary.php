...
<!--                                                                <span class="font12">Thu, 3 pm</span>-->
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    <div><h3 class="marginTop5 rdtheme"><strong><!-- <i class="fa fa-rupee"></i>--><?php echo $hotel_detail->xml_currency; ?> <?php echo $hotel_detail->total_cost; ?></strong><span class="font11">(Total fare)</span></h3>
                                ...
                                <div class="bdDone" id="itineraryDone">
                                    <div class="row detailed-row">
                                        ...
                                        <div class="col-md-3">
                                            <?php echo $hotel_detail->xml_currency; ?>. <?php echo $hotel_detail->total_cost; ?><br>
<!--                                            <span class="font11">3 adults, 2 children</span>-->
                                        </div>
                                    </div>
                                </div>
                            </section>
                            <form name="booking" method="POST" action="<?php echo WEB_URL; ?>hotel/reservation">
                                <!-- login details -->
                                ...
                                <input type="hidden" name="agent_markup" value="<?php echo $hotel_detail->agent_markup; ?>" /> 
                                <input type="hidden" name="net_amnt" value="<?php echo $hotel_detail->net_cost; ?>" /> 
                                <input type="hidden" name="total_price" value="<?php echo $hotel_detail->total_cost; ?>" /> 
                                <input type="hidden" name="hotel_code" value="<?php echo $hotel_detail->hotel_code; ?>" /> 
                                <input type="hidden" name="search_id" value="<?php echo $hotel_detail->api_temp_hotel_id; ?>" />
                                ...
                                <section  id="travellerDetails" class="verySoftShadow">
                                    <div class="bdOpen" id="travellersOpen">
                                        ...
                                        <div class="BkdtrvlrDtls">
                                                    ...
                                                    for ($a = 0; $a < $adults[$r]; $a++) {
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-3 form-group">
                                                                <input type="text" name="adults_fname[]" class="form-control" placeholder="First Name" required/>
                                                            </div>
                                                            <div class="col-md-3 form-group">
                                                                <input type="text"  name="adults_lname[]" class="form-control" placeholder="Last Name" required/>
                                                            </div>
                                                        </div>
                                                    <?php } ?>
                                                    ...
                                                    if (array_key_exists($r, $child) && $child[$r] != '') {
                                                        ...
                                                        for ($c = 0; $c < $child[$r]; $c++) {
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-3 form-group">
                                                                    <input type="text" name="childs_fname[]" class="form-control" placeholder="First Name" required />
                                                                </div>
                                                                <div class="col-md-3 form-group">
                                                                    <input type="text" name="childs_lname[]" class="form-control" placeholder="Last Name" required />
                                                                </div>
                                                            </div>
                                                            <?php
                                                        }
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-7 form-group">
                                                    <input type="text" name="user_mobile" class="form-control" placeholder="Enter your mobile number"/>
                                        ...
                                        <div class="row">
                                            <div class="col-md-2"></div>
                                            <div class="col-md-5"><button type="submit" class="btn btn-primary marginTop15">CONTINUE</button></div>
                                        </div>
                                    </div>
