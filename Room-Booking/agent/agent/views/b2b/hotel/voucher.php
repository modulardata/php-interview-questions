...
<div class="flightsContainer">
    ...
    <!--                                                <tr>
                                                    <td><strong><?php if ($hotel_booking_info->status == 'Success' && $hotel_booking_info->status == '') { ?>Booking Fee:<?php
                                                    } else {
                                                        echo 'Cancellation Fee:';
                                                    }
                                                ?></strong></td>
                                                    <td><?php if ($hotel_booking_info->status == 'Success' && $hotel_booking_info->status == '') { ?>Free<?php
                                            } else {
