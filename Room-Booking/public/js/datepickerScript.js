...
{    
    $( "#datepickerInt" ).datepicker({
        ...
        dateFormat: 'dd/mm/yy',			
        minDate: 0,
        maxDate: '$("#date_depart_int").val()+12m'
		  
    });
    $( "#datepickerInt1" ).datepicker({
        numberOfMonths: 2,
        dateFormat: 'dd/mm/yy',			
        minDate: 1,
        maxDate: '$("#date_depart_int").val()+12m'		  
    ...
    $('#datepickerInt').change(function()
    {
        ...
        else
        {
            ...
            $( "#datepickerInt1" ).val($t);
        }
    });
		  
    $('#datepickerInt1').change(function()
    {
        var selectedDate = $(this).datepicker('getDate');
        var str1 = $( "#datepickerInt" ).val();
...
{    
    ...
    $('#datepickerhot').change(function()
    {
        //$t=$(this).val();
        var selectedDate = $(this).datepicker('getDate');
        var str1 = $( "#datepickerhot1" ).val();
        ...
        else
        {
            ...
            $( "#datepickerhot1" ).val($t);
        }
    });
		  
    $('#datepickerhot1').change(function()
    {
        var selectedDate = $(this).datepicker('getDate');
        var str1 = $( "#datepickerhot" ).val();
