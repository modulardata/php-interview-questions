<div class="searchCntr">                
    ...
    <div class="searchtabs">
        <ul>
            <li><a  id="hotels">Domestic</a></li>
            <li><a class="active" id="holidays">International</a></li>
        </ul>
    </div>
    <div class="searchContentCntr">
        <div class="tab_content" style="display: none" id="tab_content_hotels">
            
                <form action="<?php echo WEB_URL; ?>dhotel/hotel_search" method="post"> 
                    ...
                    <div class="padder">
                        ...
                        <div class="row">
                            <div class="col-md-6 form-group form-inline" data-date-format="dd-mm-yyyy">
                                <input placeholder="CHECK IN" class="datePickerIcon form-control" id="datepickerhot"  name="checkin" readonly required />
                                <span stlye="color:#FF0000;"><?php echo form_error('checkin'); ?></span>
                            </div>
                            <div class="col-md-6 form-group">
                                <input placeholder="CHECK OUT" class="datePickerIcon form-control" id="datepickerhot1"  name="checkout" readonly required />
...
<!--                                <span>Register for QuickBook &amp; get upto Rs.500 off on hotels !</span>-->
        ...
        <div class="tab_content"  id="tab_content_holidays">
                    ...
                    <div class="padder">
                        <div class="form-group">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6"><input title="Type City Name" autocomplete="off" autocorrect="off" autocapitalize="off" tabindex="5" placeholder="TYPE THE LOCATION" name="City" value="<?php echo $search ?>" id="hotelcity" type="text" class="form-control" required /></div>
