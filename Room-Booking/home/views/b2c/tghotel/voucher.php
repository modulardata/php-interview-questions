...
<div class="flightsContainer">
                ...
                <div class="booking_page_box1">
                    <div class="hotel_result_right_inner_part7">
                        ...
                        <div class="hotel_result_left_heading_part4" align="center" style="text-align:center">
                            <div class="padding_10"><span class="font_size15 color_gray1" ><strong><?php if (($hotel_booking_info->Booking_Status == 'confirmed') || ($hotel_booking_info->Booking_Status == 'Confirmed')) echo 'Booking Voucher'; ?></strong></span></div>
                        </div>
                        ...
                        <div class="bgcolor_gray" style="background-color:#f7f7f4;">
                            <div>
                                ...
                                <table width="100%" border="0" cellspacing="0" cellpadding="5">
                                    <tr><td>
                                            <table width="100%" border="0" cellspacing="0" cellpadding="5">
                                                <tr><td class="bgcolor_gray1" style="font-size: 26;text-decoration: none;" align="left"><a href="<?php echo WEB_DIR; ?>" style="text-decoration: none;"><img src="<?php echo WEB_DIR; ?>public/img/logo.png" style="height:60px;width:280px"/></a></td><td>Hotel Accommodation Voucher</td><td align="right">Support: 0987654321</td></tr>
                                            </table>
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td bgcolor="#f7f7f7">
                                            <div align="justify" class="padding_10 font_size13 color_gray">
                                                <?php echo $hotel_booking_info->Booking_RefNo; ?>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td bgcolor="#f7f7f7">
                                            ...
                                            <table width="380" border="0" cellspacing="0" cellpadding="5" align="right" class="font_size13 color_gray1">
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php
                                            if (($hotel_booking_info->Booking_Status == 'confirmed') || ($hotel_booking_info->Booking_Status == 'Confirmed'))
    ...
    <!--                                                <tr>
                                                    <td><strong><?php if ($hotel_booking_info->Booking_Status == 'Success' && $hotel_booking_info->Cancellation_Status == '') { ?>Booking Fee:<?php
                                                    } else {
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="color_black font_size15">
                                                        <strong>
                                                            <?php echo $hotel_booking_info->Currecy; ?> 
                                                            <?php  echo round($hotel_booking_info->Booking_Amount, 2);     ?>
                                                        </strong></td>
                                                </tr>
                                            </table>
                                        </td>
            ...
            <table align="center" width="100%">
                <tr>
                    <td bgcolor="#e7e7e7" align="center">
                        ...
                        <h3>Sorry, No Voucher is Availbale.. Please Contact to Admin: your Reference No: <?php $voucherId ?>...</h3>
